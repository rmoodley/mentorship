...
public class Ex1 {
	...
	public void Test_5() throws Exception
	{
		...
		//Enter First Name
		utils.EnterText("xpath", "//*[contains(text(),'Name')]/following::input[1]", "Rishen");
		
		//Enter Last Name
		utils.EnterText("xpath", "//*[contains(text(),'Name')]/following::input[2]", "Moodley");
		...
		//Enter Subjects
		utils.EnterText("xpath", "//*[contains(text(),'Subjects')]/following::input[1]", "Math");
